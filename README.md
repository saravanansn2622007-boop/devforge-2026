...
- **🎬 Kollywood Tech Punchlines (Easter Egg Generator)**: Cinema clapperboard generator with take counters, dynamic hero spotlights, and one-click clipboard copy.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/saravanansn2622007-boop/devforge-2026.git
   cd devforge-2026
   ```
